-- |
-- Module      : Crypto.NaCl.Encrypt.Stream.Salsa20
...
streamGen n sz sk 
  ...
  = error "Crypto.NaCl.Encrypt.Stream.Salsa20.streamGen: bad nonce length"
  | S.length sk /= keyLength
  = error "Crypto.NaCl.Encrypt.Stream.Salsa20.streamGen: bad key length"
  | otherwise
  = Internal.streamGenWrapper c_crypto_stream_salsa20 n sz sk
...
encrypt n p sk
  | nonceLen n /= nonceLength
  = error "Crypto.NaCl.Encrypt.Stream.Salsa20.encrypt: bad nonce length"
  | S.length sk /= keyLength
  = error "Crypto.NaCl.Encrypt.Stream.Salsa20.encrypt: bad key length"
  | otherwise
  = Internal.encryptWrapper c_crypto_stream_xor_salsa20 n p sk
{-# INLINEABLE encrypt #-}
...
keyLength :: Int
keyLength = #{const crypto_stream_salsa20_KEYBYTES}

-- | Length of a 'Nonce' needed for encryption/decryption.
nonceLength :: Int
nonceLength = #{const crypto_stream_salsa20_NONCEBYTES}



foreign import ccall unsafe "glue_crypto_stream_salsa20"
  c_crypto_stream_salsa20 :: NaclStreamFfiType

foreign import ccall unsafe "glue_crypto_stream_salsa20_xor"
  c_crypto_stream_xor_salsa20 :: NaclStreamXorFfiType
